...
// weavert's own hand-written closures (Send, and Step 2's Ask) use this
// instead of the Env-slice machinery genFuncLit's AMIVM-generated
// closures need (internal/codegen/closure.go): those exist to work
// around AMIVM's CLOS-can't-nest restriction, which is irrelevant here
// since this Go source is never generated by AMIVM at all — an ordinary
// Go closure can nest and capture by reference just fine.
func wrapFn(f func(any) any) any {
	return &Closure{
		Fn:  func(_ []any, arg any) any { return f(arg) },
		Env: []any{},
	}
}
